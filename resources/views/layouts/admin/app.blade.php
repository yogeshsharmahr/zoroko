...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Jun 2020 03:47:01 GMT -->
...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('public/admin_asset/img/favicon.png') }}">
    <!-- Normalize CSS -->
    <link rel="stylesheet" href="{{ asset('public/admin_asset/css/normalize.css') }}">
    <!-- Main CSS -->
    <link rel="stylesheet" href="{{ asset('public/admin_asset/css/main.css') }}">
    <!-- Bootstrap CSS -->
    ...
    <!-- Flaticon CSS -->
    <link rel="stylesheet" href="{{ asset('public/admin_asset/fonts/flaticon.css') }}">
    <!-- Full Calender CSS -->
    <link rel="stylesheet" href="{{ asset('public/admin_asset/css/fullcalendar.min.css') }}">
    <!-- Animate CSS -->
    <link rel="stylesheet" href="{{ asset('public/admin_asset/css/animate.min.css') }}">
    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{ asset('public/admin_asset/style.css') }}">
    <!-- Modernize js -->
    <script src="{{ asset('public/admin_asset/js/modernizr-3.6.0.min.js') }}"></script>
</head>
        ...
        <div class="navbar navbar-expand-md header-menu-one bg-light">
            <div class="nav-bar-header-one">
                <div class="header-logo">
                    <a href="index.html">
                        <img src="{{ asset('public/admin_asset/img/logo.png') }}" alt="logo">
                    </a>
                </div>
                ...
                <ul class="navbar-nav">
                    <li class="navbar-item dropdown header-admin">
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            ...
                            <div class="admin-img">
                                <img src="{{ asset('public/admin_asset/img/figure/admin.jpg') }}" alt="Admin">
                            </div>
                        </a>
                            ...
                            <div class="item-content">
                                <div class="media">
                                    <div class="item-img bg-skyblue author-online">
                                        <img src="{{ asset('public/admin_asset/img/figure/student11.png') }}" alt="img">
                                    </div>
                                ...
                                <div class="media">
                                    <div class="item-img bg-yellow author-online">
                                        <img src="{{ asset('public/admin_asset/img/figure/student12.png') }}" alt="img">
                                    </div>
                                    <div class="media-body space-sm">
                                        <div class="item-title">
                                            <a href="#">
                                ...
                                <div class="media">
                                    <div class="item-img bg-pink">
                                        <img src="{{ asset('public/admin_asset/img/figure/student13.png') }}" alt="img">
                                    </div>
                                    <div class="media-body space-sm">
                                        <div class="item-title">
                                            <a href="#">
        ...
        <div class="dashboard-page-one">
            ...
            <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
               <div class="mobile-sidebar-header d-md-none">
                    <div class="header-logo">
                        <a href="index.html"><img src="{{ asset('public/admin_asset/img/logo1.png') }}" alt="logo"></a>
                    </div>
               </div>
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            <a href="#" class="nav-link"><i class="flaticon-classmates"></i><span>Manage Features</span></a>
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="{{ route('admin.managefeaturebanner') }}" class="nav-link"><i class="fas fa-angle-right"></i>Manage Banner</a>
                                </li>
                                <li class="nav-item">
                                    <a href="student-details.html" class="nav-link"><i
                                            class="fas fa-angle-right"></i>Manage Main Content</a>
                                </li>
                                <li class="nav-item">
                                    <a href="admit-form.html" class="nav-link"><i
                                            class="fas fa-angle-right"></i>Admission Form</a>
...
@yield('content')
    ...
    <!-- Plugins js -->
    <script src="{{ asset('public/admin_asset/js/plugins.js') }}"></script>
    <!-- Popper js -->
    ...
    <!-- Counterup Js -->
    <script src="{{ asset('public/admin_asset/js/jquery.counterup.min.js') }}"></script>
    <!-- Moment Js -->
    <script src="{{ asset('public/admin_asset/js/moment.min.js') }}"></script>
    <!-- Waypoints Js -->
    <script src="{{ asset('public/admin_asset/js/jquery.waypoints.min.js') }}"></script>
    <!-- Scroll Up Js -->
    <script src="{{ asset('public/admin_asset/js/jquery.scrollUp.min.js') }}"></script>
    <!-- Full Calender Js -->
    <script src="{{ asset('public/admin_asset/js/fullcalendar.min.js') }}"></script>
    <!-- Chart Js -->
    <script src="{{ asset('public/admin_asset/js/Chart.min.js') }}"></script>
    <!-- Custom Js -->
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Jun 2020 03:47:46 GMT -->
</html>